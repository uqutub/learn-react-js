# React Native And React Todo In One Progrct

Basic useful Commands list:

 * npm start / npm start to Start React Native Packager.
 * npm run start-web / npm start to Start React Packager.

This is [on GitHub](https://github.com/uqutub/learn-react-js)
